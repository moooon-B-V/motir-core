...
export interface components {
    schemas: {
        ...
        WorkItemRepairClaim: {
            ...
            reason: ("not_implemented" | "repair_on_run_target" | "no_pull_requests" | "ci_running" | "not_failing") | null;
