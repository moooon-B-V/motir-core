...
// The live channel for a REVISION job (Story MOTIR-3595 · Subtask MOTIR-3599),
// the same relay every plan-edit surface uses — browsers stream from CORE, never
// from motir-ai (the open-core invariant).
//
...
export async function GET(
  ...
  const iterator = aiPlanEditsService.streamRevise(jobId, ctx.projectId)[Symbol.asyncIterator]();
