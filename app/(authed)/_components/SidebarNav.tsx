        ...
        ? [
            {
              ...
              //
              // ⚠️ IT USED TO BRANCH (MOTIR-4873). With no active project there
              // was nothing project-scoped to configure, so the door was
              // re-pointed at the settings HOME — the workspace tier, or
              // `/settings/organization` below the reveal threshold
              // (MOTIR-3502 · organization-tier §6d). That branch served a
              // reader who no longer exists, and `workspaceTierRevealed` is
              // still read by the org/workspace rows below, so nothing else
              // moves.
