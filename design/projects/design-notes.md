...
MOTIR-4205 (`in_review` at the time of drawing, PR motir-core#2533) puts a **Public page** room
there, `id: 'public-page'`, group `access`, _"directly under Members & access"_. Two public rooms
...
**⚠️ AND `cloudOnly` IS NOT THIS STORY'S TO INVENT — it is MOTIR-4205's, and it is UNMERGED.** That
flag is a new optional field on `SettingsNavEntry`, added by the MOTIR-4171 / MOTIR-4205 work, and
this room needs it for exactly the same reason. **MOTIR-4221 must not add it a second time**: two
