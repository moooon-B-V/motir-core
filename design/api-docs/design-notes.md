...
| The `/docs` area ROOT (an index page)                          | **THIS asset** — `docs-index.mock.html` (MOTIR-2521)                                 | Draws it. Amendment 19 decided it renders; `/docs` no longer redirects (MOTIR-2523).            |
