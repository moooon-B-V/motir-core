...
| **MOTIR-6236**                       | **TAKES**     | Its composer panels are drawn at `22rem`. After this card 22rem is the **floor**, not the width, and the default at 1440 is 480px — so its boards owe the composer at the default width as well as at the floor. **Amended on the card in this pull request.**                                                                              |
...
frame. Published as MOTIR-6249's design result, which is what MOTIR-6250 and MOTIR-6236 read.
