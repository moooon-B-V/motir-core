...
| Step heading (`1 ·`)       | the sandbox page's `StepHeading`         | `--el-text`; the ordinal `--el-text-secondary`                                                                                      | —                                                             |
...
| Command block              | `CodeBlock` (`copyable`)                 | `--el-code-text` on `--el-code-bg`; caption `--el-text-secondary` on `--el-surface-soft`; border `--el-border` / `--el-border-soft` | `--radius-card`                                               |
...
| Table (wide)               | `DocBlock` `table`                       | header `--el-text-secondary` over `--el-border`; cells `--el-text-secondary` over `--el-border-soft`                                | —                                                             |
| Table (narrow card)        | `DocBlock` `table`                       | `--el-surface` fill, `--el-border-soft` border, labels `--el-text-faint`                                                            | `--radius-card`                                               |
| Group caption (`setup`, …) | `DocBlock` `table` `caption`             | `--el-text-secondary`                                                                                                               | —                                                             |
