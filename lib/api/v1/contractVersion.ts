 ...
 *
 * - `1.36.0` — MOTIR-5399 adds a fourth `shape` variant to the dispatch prompt's
 ...
 *
 *   ⚠️ RE-READ ON `origin/main` BEFORE MERGE: `V1_CONTRACT_VERSION` was `1.35.0`
 *   at `d1ab5cf4c`, so this claims `1.36.0`. If a sibling has taken it since,
