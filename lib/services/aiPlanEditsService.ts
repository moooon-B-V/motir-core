...
// `workItemsService` is deliberately NOT imported: the confirm applies its delta
// in ONE transaction composed of the work-item leaves (MOTIR-911), because that
// service's own `db.$transaction` cannot nest inside it.
