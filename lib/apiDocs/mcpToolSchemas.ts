            ...
            patch: {
              ...
              properties: {
                ...
                blockedByAdd: {
                  ...
                  items: { type: 'string' },
                  description:
                    'Dependency edges to ADD — work-item keys ("ACME-7"), real work-item ids, or `planItem:<id>` refs. Each joins the target to an item on the SAME LEVEL (epic, story or leaf), under any parent; a cross-level edge is refused `cross_level`.',
                },
                blockedByRemove: {
                  type: 'array',
                  items: { type: 'string' },
