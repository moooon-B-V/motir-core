...
const WHAT_TO_DO: Record<WorkItemTypeDto, string[]> = {
  ...
  decision: [
    ...
    '   this question would open that file to answer it. A decision that contradicts',
    '   a clause in some OTHER record does not belong in that record: it is written',
    '   where it belongs, and the clause it falsifies is cited there by name.',
