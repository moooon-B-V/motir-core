...
### Amendment 8 (2026-08-06) — the documentation area is `/docs`, not `/api-docs`; what the sandbox guide OWNS; and the profile table DERIVES from the CLI's own profile record
