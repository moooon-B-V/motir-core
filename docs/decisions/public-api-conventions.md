...
> [Amendment 10, Q3](#q3--what-moves-what-redirects-and-what-does-not-rename)).
...
> reference's prefix.** [Amendment 10, Q1](#q1--the-area-is-a-set-of-sub-areas-one-per-documented-surface-the-api-reference-owns-docsapi)
...
[Amendment 10, Q3](#q3--what-moves-what-redirects-and-what-does-not-rename)) is the
...
### Amendment 10 (2026-08-06) — the documentation area is a set of SUB-AREAS; the API reference owns `/docs/api/*`, and the operation index renders only inside it
