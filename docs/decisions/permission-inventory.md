...
| `/api/projects/[key]/monitors/[connectionId]`       | DELETE       | `assertPermission(integration:manage)` (`inProject`) — disconnect, removing the stored credential when it was the last binding                                                                                                                                 | `integration:manage`       | new              | R66 |
