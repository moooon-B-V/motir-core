...
| `approvalGatesService` records read (Approvals room)    | GET         | MOTIR-5301: `assertCanBrowse`; own records, or every record with `approval:view_any` via `getPermissions`                                                                                             | `approval:view_any`     | new      | R67 |
