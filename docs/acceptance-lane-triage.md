...
| `acceptance-agent-runs.spec.ts`             | MOTIR-1789 | **PROMOTE → main** as `agent-runs.spec.ts`.                                                                          |
...
| `acceptance-plans-surface.spec.ts`          | MOTIR-3232 | **PROMOTE → main** as `plans-surface.spec.ts`; it protects the list half, distinct from plan shapes.                 |
...
| `acceptance-roadmap-arrival.spec.ts`        | MOTIR-3833 | **PROMOTE → main** as `roadmap-arrival.spec.ts`.                                                                     |
