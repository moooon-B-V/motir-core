...
// The preview sits just BELOW the single station row (y:40, ~y:188 at its bottom),
// centred under it, so it lands in the SAME fit-to-view as the stations (no scroll).
const ROOT_X0 = 840;
const ROOT_Y0 = 260;
