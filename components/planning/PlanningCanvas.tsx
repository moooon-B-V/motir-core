...
export function PlanningCanvas({
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-[calc(var(--canvas-foot,0px)+--spacing(4))] left-4 flex overflow-hidden rounded-(--radius-card) border border-(--el-border) bg-(--el-surface) shadow-(--shadow-card)"
        role="group"
        aria-label={t('zoom')}
      >
